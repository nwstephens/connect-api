...
```{r}
Sys.setenv(CONTENT_GUID="f1b338c6-ddf4-4a3f-8282-9d5fd6cb9676")
```
...
```{bash}
curl --verbose --show-error -L --max-redirs 0 --fail -X POST \
    -H "Authorization: Key ${CONNECT_API_KEY}" \
...
```{r}
Sys.setenv(TASK="sVPvz7SbSygRAMrW")
```
